...
const alertVariants = cva("relative w-full rounded-lg border px-3 py-2 sm:px-4 sm:py-3 text-sm has-[>svg]:gap-x-2 sm:has-[>svg]:gap-x-3 gap-y-0.5 items-start [&>svg]:size-4 [&>svg]:translate-y-0.5 [&>svg]:text-current", {
  variants: {
    variant: {
